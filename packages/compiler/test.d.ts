...
import { get, getAll, insert, remove, removeAll, file as originalFile, tempFile as originalTempFile, user as originalUser } from 'aeria'

export declare type fileCollection = ExtendCollection<typeof originalFile, {description:{$id:"file",properties:{}}}>
...
export declare type tempFileCollection = ExtendCollection<typeof originalTempFile, {description:{$id:"tempFile",properties:{}}}>
...
export declare type userCollection = ExtendCollection<typeof originalUser, {description:{$id:"user",properties:{}}}>
...
export declare type petCollection = {description:{$id:"pet",properties:{}}}
